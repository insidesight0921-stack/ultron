...
목표 아키텍처의 Phase 1 데이터 경계는 [`docs/DATA_CLASSIFICATION.md`](docs/DATA_CLASSIFICATION.md)에서 관리합니다. 현재 분류·목표 스키마, P0 노출 차단, Private 권한과 로컬 DB 백업이 완료됐고 물리 분리가 남아 있습니다.
