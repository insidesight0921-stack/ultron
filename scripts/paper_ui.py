  ...
  <div id="tab-myquant" class="tab-content">
    <div class="card">
      ...
      <p class="muted" style="margin-top:0.4rem;border-left:3px solid #888;padding-left:0.6rem;">
        🔵 관찰 · ⚪ <b>보류</b> · 🚫 기각 — 조건 이름 위에 마우스를 올리면 근거가 보입니다.<br>
        <b>채택이 아니라 관찰입니다. 그리고 지금은 관찰 등급도 비어 있습니다.</b>
        2026-08-31 재측정(199종목 × 291일)에서 <b>전·후반을 모두 통과한 조건이
        없습니다.</b> 신고가돌파는 전체 기간 백분위 100이지만 전반이 0·후반이 100 —
        후반 한 구간이 만든 값입니다(전반 −0.46%p / 후반 +0.69%p).<br>
        직전 표(2026-08-29)는 전후반 <b>원수익</b>을 비교해 "+1.24%→+1.27%,
        안정적"으로 읽었는데, 같은 구간에서 아무 때나 사는 기준선도
        +2.87%→+0.67%로 떨어졌습니다. <b>시장이 내려간 것을 조건의 안정성으로
        오독</b>한 것이라 구간별 기준선 대비로 바꿔 다시 쟀습니다.<br>
        실거래로 가리려면 조건 8종·2%p 차이 기준 <b>809건</b>이 필요하고
        현재 속도(연 216건)로 3.7년입니다.
